        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="text-black font-w600 mb-1">Espace Rédacteur</h1>
                        <p class="mb-0">Bonjour {{ $user->name }}, bienvenue dans votre espace de rédaction</p>
                    </div>
                    <div>
                    ...
                    <div class="card-body box-style">
                        <div class="media align-items-center">
                            <div class="media-body me-3">
                                <h2 class="num-text text-black font-w700">{{ number_format($myArticles) }}</h2>
                                <span class="fs-14">Mes Articles</span>
                            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6">
                <div class="card card-bd">
                    ...
                    <div class="card-body box-style">
                        <div class="media align-items-center">
                            <div class="media-body me-3">
                                <h2 class="num-text text-black font-w700">{{ number_format($myPublishedArticles) }}</h2>
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6">
                <div class="card card-bd">
                    ...
                    <div class="card-body box-style">
                        <div class="media align-items-center">
                            <div class="media-body me-3">
                                <h2 class="num-text text-black font-w700">{{ number_format($myDraftArticles) }}</h2>
                    ...
                    <div class="card-body box-style">
                        <div class="media align-items-center">
                            <div class="media-body me-3">
                                ...
                                <span class="fs-14">Catégories Disponibles</span>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            @if($article->image)
                                <img src="{{ asset('storage/' . $article->image) }}" class="rounded me-3" width="50" height="50" alt="">
                            @else
                            ...
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted">{{ number_format($article->views ?? 0) }} vues</small>
                                <div class="mt-1">
                                    <span class="badge badge-success badge-sm">Publié</span>
                        ...
                        <div class="text-center py-3">
                            ...
                            <p class="text-muted mt-2">Aucun article populaire</p>
                        </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('admin.articles.index') }}" class="btn btn-outline-primary">
                                <i class="fas fa-list me-2"></i>Mes Articles
                            </a>
