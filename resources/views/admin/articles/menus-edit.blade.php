                                ...
                                <form action="{{ route('admin.menus.update', $menu) }}" method="POST">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        @php
                                            ...
                                            $selected = old('product_ids', $defaultSelected);
                                        @endphp
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="order" id="order" class="form-control" value="{{ old('order', $menu->order) }}" min="0">
                                        @error('order')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="open_new_tab" id="open_new_tab" value="1" {{ old('open_new_tab', $menu->open_new_tab) ? 'checked' : '' }}>
