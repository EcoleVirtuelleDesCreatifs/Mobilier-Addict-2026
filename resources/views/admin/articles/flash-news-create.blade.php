        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Créer une Flash News</h4>
                    <p class="mb-0">Ajouter un nouveau message flash</p>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Nouvelle Flash News</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.flash-news.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('order') is-invalid @enderror" 
                                                ...
                                                required>
                                            @for($i = 1; $i <= 8; $i++)
                                                <option value="{{ $i }}" {{ old('order', $nextOrder) == $i ? 'selected' : '' }}>
                                                    Position {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="is_active">
                                        Activer immédiatement cette flash news
                                    </label>
                                </div>
                            ...
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save"></i> Créer la Flash News
                                </button>
