                                        ...
                                        <nav id="dropdown">
                                            <ul>
                                                @forelse($menus ?? [] as $menu)
                                                    @php
                                                        $href = $menu->url ?: '#';
                                                        if (!empty($href) && !str_starts_with($href, 'http') && !str_starts_with($href, '/')) {
                                                            $href = '/' . ltrim($href, '/');
                                                        }
                                                    @endphp
                                                    <li class="{{ ($menu->children?->isNotEmpty() ? 'active' : '') }}">
                                                        <a href="{{ $href }}" target="{{ $menu->target ?? '_self' }}">{{ $menu->title }}</a>
                                                        @if($menu->children?->isNotEmpty())
                                                            <ul class="ne-dropdown-menu">
                                                                @foreach($menu->children as $child)
                                                                    @php
                                                                        $childHref = $child->url ?: '#';
                                                                        if (!empty($childHref) && !str_starts_with($childHref, 'http') && !str_starts_with($childHref, '/')) {
                                                                            $childHref = '/' . ltrim($childHref, '/');
                                                                        }
                                                                    @endphp
                                                                    <li>
                                                                        <a href="{{ $childHref }}" target="{{ $child->target ?? '_self' }}">{{ $child->title }}</a>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
                                                        @endif
