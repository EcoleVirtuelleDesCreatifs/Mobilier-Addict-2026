            ...
            <div class="deznav-scroll">
				...
				<ul class="metismenu" id="menu">
                    ...
                    @elseif(auth()->user()->role === 'editor')
                        <li>
                            <a class="has-arrow ai-icon" href="{{ route('admin.editor') }}" aria-expanded="false">
							    <i class="flaticon-layout"></i>
							    <span class="nav-text">Dashboard Éditeur</span>
						    </a>
                        </li>
                    @elseif(in_array(auth()->user()->role, ['writer', 'author']))
                        <li>
                            <a class="has-arrow ai-icon" href="{{ route('admin.writer') }}" aria-expanded="false">
							    <i class="flaticon-layout"></i>
							    <span class="nav-text">Dashboard Rédacteur</span>
						    </a>
                        </li>
                    @endif

                    {{-- Articles - accessible à tous les rôles --}}
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route("admin.articles.create") }}">Créer Article</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('admin.profile') }}" aria-expanded="false">
						    <i class="flaticon-user"></i>
