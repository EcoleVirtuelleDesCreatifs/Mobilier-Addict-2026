            ...
            <div class="container">
                ...
                <div class="electro__grid">
                    @if($section && $section->categories->count())
                        ...
                        @endforeach
                    @else
                        <a class="electro-card electro-card--large" href="{{ route('univers.show', 'cuisine') }}">
                        ...
                        <a class="electro-card" href="{{ route('univers.show', 'froid-climatisation') }}">
                        ...
                        <a class="electro-card" href="{{ route('univers.show', 'salon') }}">
                        ...
                        <a class="electro-card electro-card--wide" href="{{ route('univers.show', 'multi-media') }}">
