...
<head>
    ...
    <title>Créer mon mot de passe - Mobilier Addict</title>
    ...
    <div class="auth-wrap">
        <div class="shell">
            <div class="hero">
                <div class="brand">
                    <div class="logo">
                        <img src="{{ asset('assets/imgs/logo-2.png') }}" alt="Mobilier Addict">
                    </div>
                    <div>
                ...
                <p class="subtitle">Définissez un mot de passe pour activer votre compte administrateur et accéder au tableau de bord.</p>
            </div>
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="form-row">
                        ...
                        <input id="email" type="email" name="email" required value="{{ old('email', $request->email) }}" placeholder="ex: admin@mobilier-addict.com" autocomplete="username">
                    </div>

                    <div class="form-row">
                        <label for="password">Mot de passe</label>
                        <input id="password" type="password" name="password" required placeholder="Choisir un mot de passe" autocomplete="new-password">
                    </div>

                    <div class="form-row">
                        <label for="password_confirmation">Confirmer le mot de passe</label>
                        <input id="password_confirmation" type="password" name="password_confirmation" required placeholder="Confirmer" autocomplete="new-password">
                    </div>

                    <div class="actions">
                        <a class="link" href="{{ route('login') }}">Retour à la connexion</a>
                    </div>
